function __okclient_show_help {
    ...
    printf "                                        Can be used to generically get the records array from an API response\n"
    ...
    printf "                                        Shows the name and type of top level properties of the first Instance.\n"
